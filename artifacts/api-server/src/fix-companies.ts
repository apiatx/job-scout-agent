...
const companies: { name: string; ats_type: string; ats_slug?: string; careers_url?: string }[] = [
  ...
  { name: 'Bentley Systems', ats_type: 'plain', careers_url: 'https://jobs.bentley.com' },
  { name: 'Crane NXT', ats_type: 'plain', careers_url: 'https://www.cranenxt.com/en/careers' },
  { name: 'Scale AI', ats_type: 'greenhouse', ats_slug: 'scaleai' },
  { name: 'Enverus', ats_type: 'plain', careers_url: 'https://www.enverus.com/about/careers' },
  ...
  // Converted from Greenhouse to plain (Greenhouse API blocked from Replit IP)
  { name: 'Cohesity', ats_type: 'plain', careers_url: 'https://www.cohesity.com/company/careers/' },
  { name: 'Urbint', ats_type: 'plain', careers_url: 'https://urbint.com/careers' },
  ...
  { name: 'Xylem', ats_type: 'plain', careers_url: 'https://www.xylem.com/en-us/careers/' },
  { name: 'Trimble', ats_type: 'workday', careers_url: 'trimble.wd1.myworkdayjobs.com', ats_slug: 'TrimbleCareers' },
  { name: 'Aspen Technology', ats_type: 'workday', careers_url: 'aspentech.wd5.myworkdayjobs.com', ats_slug: 'aspentech' },
